...
// ============================================================================
// Scene-deletion undo (file-level helper)
// ============================================================================

// restoreDeletedSceneFile rewrites a deleted scene's .scene file from the captured
// bytes, recreating its directory first in case the last file in it was removed. It is
// the undo half of a scene deletion, recorded in the editor history by the scene list.
func restoreDeletedSceneFile(path string, content []byte) error {
